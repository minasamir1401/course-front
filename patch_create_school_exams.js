...
const file = 'src/app/school-admin/exams/new/page.tsx';
if (fs.existsSync(file)) {
  ...
  c = c.replace(
    /const res = await fetch\(`\$\{API_URL\}\/school\/exams`, {[\s\S]*?method: "POST",/,
    `
        const method = createdId ? "PUT" : "POST";
        const url = createdId 
          ? \`\${API_URL}/school/exams/\${createdId}\`
  ...
  console.log('Modified school-admin/exams/new');
}
