...
// 4. Add the FolderOutput button and dropdown
const searchStr = `<button
                                    onClick={() => setExpandedIndex(expandedIndex === index ? null : index)}`;

if (!content.includes('<FolderOutput className="w-4 h-4" />')) {
  content = content.replace(searchStr, `<div className="relative move-dropdown-container">
                                    <button
