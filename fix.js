...
code = code.replace(`
            ...
            <p className="text-slate-400 text-sm font-bold mt-1">{headerDesc}</p>`, replacement + `            </h4>
            <p className="text-slate-400 text-sm font-bold mt-1">{headerDesc}</p>`);

fs.writeFileSync('src/app/super-admin/exams/new/components/QuestionsBuilder.tsx', code);
