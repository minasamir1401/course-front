...
import {
  ...
  selectSynchronizedEditorModule,
...
assert.equal(selectSynchronizedEditorModule('module-1', currentModule), currentModule);
assert.equal(selectSynchronizedEditorModule('module-2', currentModule), null);
