          ...
          <div className="flex flex-wrap gap-2.5 items-center">
            ...
            {source === 'questions' && (
              <button
                ...
                className="bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-300 px-4 py-2.5 rounded-xl font-black flex items-center gap-2 transition-all cursor-pointer shadow-sm text-xs disabled:opacity-50"
                title={language === 'ar' ? 'فحص وحذف الأسئلة المكررة والفارغة بأمان' : 'Safely clean duplicate and empty questions'}
              >
                ...
                {language === 'ar' ? '🧹 تنظيف التكرارات والأسئلة الفارغة' : '🧹 Clean Duplicates & Empty'}
              </button>
            )}
            <button
              type="button"
