                  ...
                  <div className="p-8 md:p-12 space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-slate-50 border border-slate-200 rounded-[30px] shadow-sm mb-6">
                      <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t('schoolAdmin.examsNewPage.slideType') || "Slide Type"}</label>
                        <select 
...
return (
    <DashboardLayout>
      ...
      {previewQuestion && (
        <div className={`fixed inset-0 z-[100] bg-white w-full h-full flex flex-col overflow-hidden animate-in fade-in duration-300 ${language === 'ar' ? 'rtl' : 'ltr'}`} dir={language === 'ar' ? 'rtl' : 'ltr'}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-6 rounded-3xl border-2 hover:shadow-md transition-all flex items-center gap-5 group cursor-pointer ${language === 'ar' ? 'text-right' : 'text-left'} ${bgClass}`}
                        >
