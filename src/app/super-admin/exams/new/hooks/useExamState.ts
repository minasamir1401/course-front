...
export const useExamState = (schoolIdParam: string | null) => {
  ...
  const validSchoolId = schoolIdParam && schoolIdParam !== "null" ? schoolIdParam : null;
  ...
  const [examData, setExamData] = useState<ExamData>({
    ...
    subjects: [],
    country: "مصر",
    isCentral: !validSchoolId,
    schoolIds: validSchoolId ? [validSchoolId] : [],
    duration: 60,
    password: "",
  ...
  const [visibleStandaloneCount, setVisibleStandaloneCount] = useState(20);
