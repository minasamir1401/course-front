              ...
              >
                <div className="p-8 md:p-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    {(() => {
                      const opts = typeof answer.question.options === 'string' ? JSON.parse(answer.question.options) : answer.question.options;
                  ...
                  {answer.question.explanation && renderExplanation(answer.question.explanation, true)}
                </div>
              </div>
            ))}
          </div>
