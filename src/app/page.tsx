...
import { 
  ...
  BookOpen, CheckCircle, Trophy, Hexagon
} from 'lucide-react';
import Navbar from "./Navbar";

export const metadata: Metadata = {
  title: "Klevro | منصة التعليم الذكي والتقييم المتكامل",
  description: "منصة تعليمية متكاملة لإدارة المدارس ومراكز التدريب وإجراء الاختبارات الذكية بكفاءة وسلاسة.",
};
