    ...
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        <div className="flex justify-between items-center bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <div>
            ...
            <div className="text-sm text-slate-500 mt-1 flex items-center gap-2">
              <span>الرئيسية</span> <span className="text-slate-300">/</span> <span>الملف الشخصي</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">صفحة الملف الشخصي قيد التطوير</h3>
