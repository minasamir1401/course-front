...
import { 
  X, Target, Clock, Layout, FileText, HelpCircle, FileJson, Plus, Trash2, 
  Video, BookOpen, ChevronDown, ChevronUp, Play, CheckCircle2, AlertCircle, 
  Upload, Download, Eye, Monitor, ListOrdered, Clock as ClockIcon, Lightbulb, 
  MessageSquareQuote, TriangleAlert, Search, Edit2, Save
} from "lucide-react";
