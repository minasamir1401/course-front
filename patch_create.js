...
const file = 'src/app/school-admin/courses/create/page.tsx';
...
c = c.replace(
  /const res = await fetch\(`\$\{API_URL\}\/school\/courses`, {[\s\S]*?method: "POST",/,
  `
      const method = createdId ? "PUT" : "POST";
      const url = createdId 
        ? \`\${API_URL}/school/courses/\${createdId}\`
...
console.log('Modified school-admin/courses/create');
